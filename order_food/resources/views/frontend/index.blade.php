                ...
                <div class="blog-box clearfix">
                        ...
                        <div class="col-md-6 col-sm-6">
                            <div class="blog-block">
                                <div class="blog-img-box">
                                    <img src="images/spagite.jpg" alt="" />
                                    <div class="overlay">
                                ...
                                <div class="blog-dit">
                                    ...
                                    <h4>A sufficient amount of table salt should be placed in the boiling water for the pasta, which will give it an unusual taste. Add the table salt to the pasta boiling water as soon as the water boils.</h4>
                        ...
                        <div class="col-md-6 col-sm-6">
                            <div class="blog-block">
                                ...
                                <div class="blog-dit">
                                    ...
                                    <h4>When boiling eggs it is not recommended to take them out directly from the refrigerator to boil in hot water, as that will crack and the yolk and white will come out of the shell.</h4>
                                    <!-- <h5></h5> -->
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="wow fadeIn" data-wow-duration="1s" data-wow-delay="0.1s">
                        <div class="col-md-6 col-sm-6">
                            <div class="blog-block">
                                ...
                                <div class="blog-dit">
                                    <h3 style="color:red">BAKING TIPS FROM THE PROS</h3>

                                    <h4>When starting to form and prepare baked goods, we must not put a lot of flour on the surface that we are working on, because this causes the pastry to dry out when preparing it.</h4>
                    ...
                    <div class="wow fadeIn" data-wow-duration="1s" data-wow-delay="0.1s">
                        <div class="col-md-6 col-sm-6">
                            <div class="blog-block">
                                <div class="blog-img-box">
                                    <img src="images/sous.jpg" alt="" />
                                    {{-- <div class="overlay">
                                        <a href=""><i class="fa fa-link" aria-hidden="true"></i></a>
                                    </div> --}}
                                </div>
                                <div class="blog-dit">
                                    <h3 style="color:red">Top Homemade Salad Dressings</h3>
                                    <h4>When adding spices, herbs or garlic and onions to the dressing
                                        Mix them together first and then keep them in the refrigerator for at least an hour to ensure that the flavor penetrates properly</h4>
